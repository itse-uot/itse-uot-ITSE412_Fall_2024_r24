...
if ($query !== '') {
    ...
    $stmt = $conn->prepare("SELECT * FROM users WHERE FullName LIKE :query");
                  ...
                  <div class="card-body d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center" style="gap: 20px; width: 100%;">
                      ...
                      <div>
                        ...
                        <p class="mb-0 text-muted">المجال: <?= isset($org['Field']) ? $org['Field'] : 'غير متوفر'; ?></p>
                        <p class="mb-0 text-muted">الموقع: <?= isset($org['Location']) ? $org['Location'] : 'غير متوفر'; ?></p>
                      </div>
                    </div>
                  </div>
                </div>
