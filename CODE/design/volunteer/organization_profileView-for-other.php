    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="card mb-4" style="max-width: 620px; margin: auto;">
          <div class="d-flex align-items-center p-2">
            <img src="assets/img/prof.jpeg" alt="Event Image" class="rounded-circle me-3" style="width: 50px; height: 50px;">
            <div>
              <h6 class="m-0">حملة التبرع بالدم</h6>
              <small class="text-muted">تاريخ: 2023-09-20</small>
            </div>
          </div>
          <img src="assets/img/Turkey __ ig_ @withahsen.jpeg" class="card-img-top" alt="Event Image" style="height: 220px; object-fit: cover;">
          <div class="card-body">
      ...
      <div class="col-12">
        <div class="card mb-4" style="max-width: 620px; margin: auto;">
          ...
          <div class="card-body">
            <h5 class="card-title">تفاصيل الفعالية</h5>
            <p class="card-text mb-1"><strong>الوصف:</strong> توزيع سلال غذائية على الأسر المحتاجة في طرابلس وضواحيها.</p>
